...
- Update to Baselibs v8.33.0 by default
...
- Added `ulimit -s unlimited` to `runtests.yml`
...
- Update to Baselibs v8.32.0 by default
...
- Update to Baselibs v8.29.0 by default

## [5.26.0] - 2026-03-25

### Added

- Added new `run_gocart_tests` command and job to run GOCART tests against a MAPL3 GEOSgcm build
...
- Update to Baselibs 8.27.0 by default

## [5.24.0] - 2026-03-09

### Changed

- Update default ocean to `o2`

## [5.23.0] - 2025-12-19

### Changed

- Update to Baselibs 8.24.0 by default
...
- Updated to Baselibs 8.19.0 by default

## [5.19.0] - 2025-08-27

### Changed

- Updated to Baselibs 8.18.0 by default
